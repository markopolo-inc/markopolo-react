...
function attachFunctions(themeBase) {
  return __spreadProps$4(__spreadValues$f({}, themeBase), {
    fn: {
...
var Emotion = /* #__PURE__ */withEmotionCache(function (props, cache, ref) {
  ...
  if (!isBrowser$1 && rules !== undefined) {
    ...
    possiblyStyleElement = /*#__PURE__*/reactExports.createElement("style", (_ref = {}, _ref["data-emotion"] = cache.key + " " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
var ClassNames = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  if (!isBrowser$1 && rules.length !== 0) {
    ...
    possiblyStyleElement = /*#__PURE__*/reactExports.createElement("style", (_ref = {}, _ref["data-emotion"] = cache.key + " " + serializedHashes.substring(1), _ref.dangerouslySetInnerHTML = {
      __html: rules
    }, _ref.nonce = cache.sheet.nonce, _ref));
  } // Need to return the same number of siblings or else `React.useId` will cause hydration mismatches.
...
function GlobalStyles({ theme }) {
  return /* @__PURE__ */ React.createElement(Global, {
    styles: {
      ...
      body: __spreadProps$3(__spreadValues$e({}, theme.fn.fontStyles()), {
  ...
  return Object.keys(currentTheme).reduce((acc, key) => {
    if (key === "headings" && themeOverride.headings) {
      const sizes = themeOverride.headings.sizes ? Object.keys(currentTheme.headings.sizes).reduce((headingsAcc, h) => {
        headingsAcc[h] = __spreadValues$d(__spreadValues$d({}, currentTheme.headings.sizes[h]), themeOverride.headings.sizes[h]);
        return headingsAcc;
      }, {}) : currentTheme.headings.sizes;
      return __spreadProps$2(__spreadValues$d({}, acc), {
        headings: __spreadProps$2(__spreadValues$d(__spreadValues$d({}, currentTheme.headings), themeOverride.headings), {
          sizes
        })
      });
    }
    acc[key] = typeof themeOverride[key] === "object" ? __spreadValues$d(__spreadValues$d({}, currentTheme[key]), themeOverride[key]) : typeof themeOverride[key] === "number" ? themeOverride[key] : themeOverride[key] || currentTheme[key];
    return acc;
  }, {});
}
...
function useMantineTheme() {
  var _a;
  return ((_a = reactExports.useContext(MantineProviderContext)) == null ? void 0 : _a.theme) || DEFAULT_THEME;
}
function useMantineThemeStyles(component) {
  const ctx = reactExports.useContext(MantineProviderContext);
  return { styles: ctx.styles[component] || {}, classNames: ctx.classNames[component] || {} };
}
function useMantineEmotionOptions() {
  var _a;
  return ((_a = reactExports.useContext(MantineProviderContext)) == null ? void 0 : _a.emotionOptions) || { key: "mantine", prepend: true };
}
function useMantineDefaultProps(component, defaultProps, props) {
  var _a, _b;
  const contextProps = ((_b = (_a = reactExports.useContext(MantineProviderContext)) == null ? void 0 : _a.defaultProps) == null ? void 0 : _b[component]) || {};
  return __spreadValues$c(__spreadValues$c(__spreadValues$c({}, defaultProps), contextProps), filterProps(props));
}
function MantineProvider({
  ...
  const ctx = reactExports.useContext(MantineProviderContext);
  const overrides = {
    themeOverride: inherit ? __spreadValues$c(__spreadValues$c({}, ctx.theme), theme) : theme,
    emotionOptions: inherit ? __spreadValues$c(__spreadValues$c({}, ctx.emotionOptions), emotionOptions) : emotionOptions,
    styles: inherit ? __spreadValues$c(__spreadValues$c({}, ctx.styles), styles) : styles,
    classNames: inherit ? __spreadValues$c(__spreadValues$c({}, ctx.classNames), classNames) : classNames,
    defaultProps: inherit ? __spreadValues$c(__spreadValues$c({}, ctx.defaultProps), defaultProps) : defaultProps
  };
...
function extractSystemStyles(others) {
  const _a = others, { m, mx, my, mt, mb, ml, mr, p, px, py, pt, pb, pl, pr } = _a, rest = __objRest$8(_a, ["m", "mx", "my", "mt", "mb", "ml", "mr", "p", "px", "py", "pt", "pb", "pl", "pr"]);
...
function getRef(args) {
  ...
  const argCopy = __spreadValues$b({}, arg);
...
function useUuid(staticId) {
  const [uuid, setUuid] = reactExports.useState("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
const Box = reactExports.forwardRef((_a, ref) => {
  var _b = _a, { className, component, style, sx } = _b, others = __objRest$7(_b, ["className", "component", "style", "sx"]);
  const { systemStyles, rest } = extractSystemStyles(others);
  const Element = component || "div";
  return /* @__PURE__ */ React.createElement(Element, __spreadValues$a({
    ref,
...
var useStyles$2 = createStyles((theme, { color, size, radius }) => ({
  root: __spreadProps$1(__spreadValues$9(__spreadValues$9({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
...
function Bars(_a) {
  var _b = _a, { size, color } = _b, others = __objRest$6(_b, ["size", "color"]);
...
function Oval(_a) {
  var _b = _a, { size, color } = _b, others = __objRest$5(_b, ["size", "color"]);
...
function Dots(_a) {
  var _b = _a, { size, color } = _b, others = __objRest$4(_b, ["size", "color"]);
...
function Loader(props) {
  const _a = useMantineDefaultProps("Loader", defaultProps$2, props), {
    size = "md",
    color,
    variant
  ...
  return /* @__PURE__ */ React.createElement(Box, __spreadValues$5({
    role: "presentation",
...
const ActionIcon = reactExports.forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("ActionIcon", defaultProps$1, props), {
    className,
    color,
    children,
    radius,
  ...
  const { classes, cx, theme } = useStyles$3({ size, radius, color }, { name: "ActionIcon", classNames, styles });
  const colors = theme.fn.variant({ color, variant: "light" });
  const loader = /* @__PURE__ */ React.createElement(Loader, __spreadValues$4({
    color: colors.color,
    size: theme.fn.size({ size, sizes }) - 12
  }, loaderProps));
  return /* @__PURE__ */ React.createElement(Box, __spreadValues$4({
...
const CloseButton = reactExports.forwardRef((_a, ref) => {
  var _b = _a, { iconSize, size = "md" } = _b, others = __objRest$1(_b, ["iconSize", "size"]);
  const theme = useMantineTheme();
  const _iconSize = iconSize || theme.fn.size({ size, sizes: iconSizes });
  return /* @__PURE__ */ React.createElement(ActionIcon, __spreadValues$2({
    size,
    ref
...
var useStyles = createStyles((theme, { color, radius, variant }, getRef) => ({
  ...
  message: __spreadProps(__spreadValues$1({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight,
    textOverflow: "ellipsis",
    overflow: "hidden",
    fontSize: theme.fontSizes.sm,
...
const Alert = reactExports.forwardRef((props, ref) => {
  ...
  const { classes, cx } = useStyles$1({ color, radius, variant }, { classNames, styles, name: "Alert" });
...
export { Alert, GlobalStyles, MantineProvider, NormalizeCSS };
